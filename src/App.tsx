...
const roleIcons: Record<string, JSX.Element> = {
  ...
  'Healthcare workers': (
    <>
      <path d="M12 19.5C8.6 16.2 4.5 13.3 4.5 9.3 4.5 7.1 6.2 5.4 8.3 5.4c1.6 0 2.9 1 3.7 2.3.8-1.3 2.1-2.3 3.7-2.3 2.1 0 3.8 1.7 3.8 3.9 0 4-4.1 6.9-7.5 10.2Z" />
      <path d="M12 9.4v4M10 11.4h4" />
    </>
  ),
  Lawyers: (
    <>
